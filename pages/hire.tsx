      ...
      <section className="bg-moss text-cream py-16">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="text-center">
            ...
            <div className="inline-flex items-center gap-3 bg-redwood text-cream px-6 py-3 rounded-lg">
      ...
      <section className="py-16 bg-cream">
        <div className="max-w-6xl mx-auto px-4 sm:px-6 lg:px-8">
          ...
          <div className="mt-12 text-center">
            <div className="bg-redwood text-cream rounded-lg p-8 shadow-lg">
              ...
              <div className="flex flex-col sm:flex-row gap-4 justify-center items-center">
                <a
                  ...
                  className="inline-flex items-center gap-2 bg-cream text-redwood px-8 py-4 rounded-lg font-headline font-bold text-xl hover:bg-sand transition-colors shadow-md"
                >
                  <span>📞</span>
          ...
          {/* How It Works */}
          <div className="mt-16">
            <h3 className="text-2xl font-headline font-bold text-redwood mb-8 text-center">
              How It Works
            </h3>
            <div className="grid grid-cols-1 md:grid-cols-3 gap-6">
              <div className="text-center p-6">
                ...
                <h4 className="font-headline font-bold text-lg text-redwood mb-2">Call or Email</h4>
              ...
              <div className="text-center p-6">
                ...
                <h4 className="font-headline font-bold text-lg text-redwood mb-2">We Match You</h4>
                <p className="text-moss font-body">
              ...
              <div className="text-center p-6">
                ...
                <h4 className="font-headline font-bold text-lg text-redwood mb-2">Get It Done</h4>
                <p className="text-moss font-body">
