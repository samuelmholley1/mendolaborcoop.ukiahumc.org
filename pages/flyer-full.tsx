...
const FlyerFullPage: React.FC = () => {
  ...
  const Flyer = () => (
    ...
    >
      ...
      <div className="grid grid-cols-2 gap-4 flex-grow mx-auto" style={{ width: '75%' }}>
      ...
      <div className="text-center flex-shrink-0 flex items-start justify-center border-t border-moss/30 mt-4 pt-2" style={{ height: '7%' }}>
