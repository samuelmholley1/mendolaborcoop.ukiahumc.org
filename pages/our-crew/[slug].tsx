          ...
          <div className="max-w-md mx-auto px-4">
            <div className="bg-white rounded-lg shadow-lg p-8">
              ...
              <p className="text-center text-sm text-moss/60 mt-6">
                Contact Cheryl (369) 216-1512 or Braven (559) 880-0960 if you need access.
              </p>
            </div>
          </div>
        </section>
                ...
                <div className="space-y-4 mb-6">
                  <div className="flex items-start gap-3">
                    ...
                    <div>
                      ...
                      <p className="text-cream/70 text-sm">Call our coordinators Cheryl & Braven to check availability</p>
                    </div>
                  </div>
                  <div className="flex items-start gap-3">
